...
class QuickSortTest(unittest.TestCase):
    ...
    def testFloats(self):
        ...
        mergeSort: InsertionSort = InsertionSort(dataToSort=floats, sortingCanvas=None)
    ...
    def testInts(self):
        ...
        mergeSort: InsertionSort = InsertionSort(dataToSort=integers, sortingCanvas=None)
